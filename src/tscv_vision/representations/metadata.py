...
def validation_matrix_markdown() -> str:
    ...
    lines = [
        ...
        *(f"| {level.label} | {_LEVEL_MEANING[level]} |" for level in ValidationLevel),
        ...
        "LEVEL 3. A committed real-dataset run exists for the default method",
        "set, but no individual encoder has been promoted to LEVEL 4 until its",
        "benchmark claim is reviewed in that narrower context",
